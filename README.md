...
![과제1 기본 구성](img/과제1실행화면1-1.png)
기본적인 UI구성, Placeholder로 아이디와 패스워드 입력 안내, 로그인 버튼이 배치된 화면

![과제1 로그인 성공](img/과제1실행화면1-2.png)
성공적으로 로그인한 경우의 메시지 박스 화면

![과제1 로그인 실패](img/과제1실행화면1-3.png)
...
## 실행 화면 (과제2)
- 과제2 코드의 실행 스크린 샷
![과제2 성공화면](img/과제2_실행1.png)
![과제2 실패화면](img/과제2_실행2.png)

- 과제 내용
	- 아이디 또는 패스워드가 잘못 입력되었을 때 에러 메시지 전환
	- MessageBox를 띄우지 않고 아이디와 패스워드를 입력하는 곳에 나타냄
